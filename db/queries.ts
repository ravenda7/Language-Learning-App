...
import { userProgress, courses, units, challenges, challengeProgress, lessons, challengeOptions, userSubscription } from './schema';
import { quickSort } from "@/utils/quicksorting";
...
export const getCourseProgress = cache(async () => {
    ...
    const firstUncompletedLesson = unitsInActiveCourse.flatMap((unit) => unit.lessons).find((lessons) => {
...
export const getUserSubscription = cache(async () => {
    ...
    return {
        ...data,
        isActive: !!isActive, // Converting into boolean type
    };
});
